...
public class frmTransaksi extends javax.swing.JFrame {
	...
	DefaultTableModel tableModel = new DefaultTableModel(
		new Object [][] {},
		new String [] {
		"Kd Barang", "Nama Barang","Harga Barang","Jumlah","Total","diskon"
	});
        String idBrg;
        String namaBrg;
        String hargaBrg;
    ...
    private void hitung_jual(){
        double xtot,xhrg,xtot1,xtot2;
        int xjml,xDiskon;

        xhrg=Double.parseDouble(txtHarga.getText());
        xjml=Integer.parseInt(txtJml.getText());
        xDiskon=Integer.parseInt(txtDiskon.getText());
        xtot1=xhrg*xjml;
        xtot2=xtot1*xDiskon/100;
        xtot=xtot1-xtot2;
    ...
    private void detail_barang(String xkode){            
        try {
            ...
            if (RsBrg.next()) {
                ...
                int diskon =RsBrg.getInt("diskon");
    ...
    private void simpan_ditabel()
    {
        try{
            ...
            int diskon1=Integer.parseInt(txtDiskon.getText());
            double tot=Double.parseDouble(txtTot.getText());
            tableModel.addRow(new Object[]{tKode,tNama,hrg,jml,tot,diskon1});
            inisialisasi_tabel();
        }
        catch(Exception e)
        {
    ...
    private void simpan_transaksi()
    {
        try{
            ...
            for(int i=0;i<tblJual.getRowCount();i++)
            {
                ...
                int diskon=(Integer)tblJual.getValueAt(i,5);
                String zsql="insert into djual values('"+xnojual+"','"+xkd+"',"+xhrg+","+xjml+","+diskon+")";
    ...
    private void initComponents() {
        ...
        tblJual.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kd Barang", "Nama Barang", "Harga", "Jumlah", "Total", "diskon"
            }
        ));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(cmbKd_Brg, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
